  ...
  <div class="container-fluid max-width: 100%; ">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <form class="float md -right">
        <input class="form-control md-right" type="search" placeholder="Search" aria-label="Search" this.form.id>
...
export default {
   Search() {
            ...
            axios.get("http://51.75.121.250:4000/api/users?username=u&authToken=&email=e@gmail.com", 
            {
                id:this.form.id
            })
            .then((e) => {
